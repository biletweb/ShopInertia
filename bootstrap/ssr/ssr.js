...
const Navbar$1 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["ssrRender", _sfc_ssrRender$b]]);
const _sfc_main$a = {
  data() {
    return {
...
_sfc_main$a.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Admin/Footer.vue");
...
function _sfc_ssrRender$8(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div> Admin Index Content </div><!--]-->`);
}
...
const Index$1 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$8]]);
const __vite_glob_0_0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Index$1
}, Symbol.toStringTag, { value: "Module" }));
const Pagination_vue_vue_type_style_index_0_scoped_a66ae22e_lang = "";
const _sfc_main$7 = {
  components: {
    Link
  },
...
function _sfc_ssrRender$7(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if ($props.links.length > 3) {
    _push(`<nav${ssrRenderAttrs(mergeProps({ "aria-label": "Page navigation" }, _attrs))} data-v-a66ae22e><ul class="pagination pagination-sm justify-content-end mb-0" data-v-a66ae22e><!--[-->`);
    ssrRenderList($props.links, (link) => {
      _push(`<li class="${ssrRenderClass([{ "active": link.active, "disabled": link.url === null }, "page-item"])}" data-v-a66ae22e>`);
      _push(ssrRenderComponent(_component_Link, {
        href: link.url ?? "",
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Admin/Pagination.vue");
...
const _imports_0 = "/build/assets/logo-066d1b38.jpg";
const _sfc_main$3 = {
  components: {
    Link
  }
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Shop/Navbar.vue");
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "content-footer footer bg-primary rounded-3 mt-3 mb-2" }, _attrs))}><div class="container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 py-3"><div><a href="javascript:void(0)" class="footer-text fw-bold">${ssrInterpolate(_ctx.$page.props.appName)}</a> © ${ssrInterpolate($data.currentYear)}</div><div><a href="javascript:void(0)" class="footer-link me-4">Contacts</a><a href="javascript:void(0)" class="footer-link">Delivery</a></div></div></footer>`);
}
const _sfc_setup$2 = _sfc_main$2.setup;
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Shop/Footer.vue");
...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => {
      const pages = /* @__PURE__ */ Object.assign({ "./Pages/Admin/Index.vue": __vite_glob_0_0, "./Pages/Admin/Users/Create.vue": __vite_glob_0_1, "./Pages/Admin/Users/Edit.vue": __vite_glob_0_2, "./Pages/Admin/Users/Users.vue": __vite_glob_0_3, "./Pages/Shop/Index.vue": __vite_glob_0_4 });
